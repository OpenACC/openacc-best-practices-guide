...
openacc-guide.pdf: ${MDFILES} ${IMGFILES}
	${PANDOC} -f markdown+implicit_figures -s -o openacc-guide.pdf ??-*.markdown --filter pandoc-citeproc --highlight-style pygments --top-level-division=chapter -V geometry:letterpaper
